...
def is_feasible(mu, nu, a3, a5):
    ...
    if (a4 + a7) & (1 - a1 - a2 - a3 - a5) == NULL_INT:
        return False             
...
# Divide-and-Conquer Algorithm! We construct a grid over (mu, nu, a3, a5) 
...
print("Attempting Case 1|234|57")
...
if not case_queue.empty():
    ...
    print(f"Case 1|234|57 is Not Yet Infeasible! A Total of {ctr} Boxes Were Considered...\n\n")
else:
    print(f"\t Current Depth is {curr_depth:3} ... There are {next_size:7} Boxes Remaining...\n")
    print(f"Case 1|234|57 is Infeasible! A Total of {ctr} Boxes Were Considered...\n\n")
