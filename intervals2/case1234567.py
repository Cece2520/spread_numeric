...
def is_feasible(mu, nu, a3, a6):
    ...
    if (a4 + a7) & (1 - a1 - a2 - a3 - a5 - a6) == NULL_INT:
        return False             
...
print("Attempting Case 1|234|567")
...
if not case_queue.empty():
    ...
    print(f"Case 1|234|567 is Not Yet Infeasible! A Total of {ctr} Boxes Were Considered...\n\n")
else:
    print(f"\t Current Depth is {curr_depth:3} ... There are {next_size:7} Boxes Remaining...\n")
    print(f"Case 1|234|567 is Infeasible! A Total of {ctr} Boxes Were Considered...\n\n")
