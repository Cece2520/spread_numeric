...
# case 1|24|567 via interval arithmetic and a divide and conquer
# algorithm
...
def is_feasible(mu, nu, a2, a6):
    ...
    a4n, a7n = a47_assume2457(a1,a2,0,a5,a6,mu,nu,fvec,gvec)
    ...
    if (a4 + a7) & (1 - a1 - a2 - a5 - a6) == NULL_INT:
        return False             
...
# Divide-and-Conquer Algorithm! We construct a grid over (mu, nu, a2, a6) 
...
print("Attempting Case 1|24|567")
...
if not case_queue.empty():
    ...
    print(f"Case 1|24|567 is Not Yet Infeasible! A Total of {ctr} Boxes Were Considered...\n\n")
else:
    print(f"\t Current Depth is {curr_depth:3} ... There are {next_size:7} Boxes Remaining...\n")
    print(f"Case 1|24|567 is Infeasible! A Total of {ctr} Boxes Were Considered...\n\n")
