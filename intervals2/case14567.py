...
# Divide-and-Conquer Algorithm! We construct a grid over (mu, nu, a4, a6) 
...
if not case_queue.empty():
    ...
    print(f"Case 1|4|567 is Not Yet Infeasible! A Total of {ctr} Boxes Were Considered...\n\n")
else:
    print(f"\t Current Depth is {curr_depth:3} ... There are {next_size:7} Boxes Remaining...\n")
    print(f"Case 1|4|567 is Infeasible! A Total of {ctr} Boxes Were Considered...\n\n")
