...
function is_feasible_124567(mu, nu, a2, a6, c)
    ...
    a4 = intersect( a4_assume12N4(a2, mn, v), UNIT_INT)
    ...
    fvec = [f1, f2, nothing, f4, f5, f6, f7]
    gvec = [g1, g2, nothing, g4, g5, g6, g7]
    ...
    if isempty( intersect(a4 + a7, 1 - a1 - a2 - a5 - a6))
        return false             
    end
